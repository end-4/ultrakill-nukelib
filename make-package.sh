...
ASSEMBLY_NAME="NukeLib.dll"
DOC_NAME="NukeLib.xml"
...
MOD_FOLDER="$ROOT_DIR"
ASSEMBLY_PATH="$MOD_FOLDER/bin/$CONFIGURATION/netstandard2.1/$ASSEMBLY_NAME"
DOC_PATH="$MOD_FOLDER/bin/$CONFIGURATION/netstandard2.1/$DOC_NAME"
